...
public:
  ...
  */
  ...
  static void set_global_streambuf(streambuf *buf, bool set_to_existing_loggers = true);
  static void set_global_logfile(const string &filename, bool set_to_existing_loggers = true);
};
